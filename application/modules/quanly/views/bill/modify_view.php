<div class="portlet box blue">
    ...
    <div class="portlet-body form">
        <!-- BEGIN FORM-->
        <form action='<?php echo base_url()?>quanly/bill/<?php echo $action ?>/<?php echo  (isset($info['id']))?$info['id']:"" ?>' class="form-horizontal" method="post" enctype="multipart/form-data" id="a">
            ...
            <div class="form-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6">
                        <input type="text" id='compose_number' required="required" name='compose_number' placeholder="Số Soạn Hàng ..." class='form-control' value='<?php
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6">
                        <select id='product_id' name='product_id'class='select2 form-control' >
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6">
                        <select id='customer_id' name='customer_id'class='select2 form-control'>
                            ...
                            <option value="<?php echo $customer['user_id'] ?>" <?php echo (isset($info['customer_id']) && $info['customer_id'] === $customer['user_id']) ? 'selected' : ''; ?>><?php echo $customer['user_name'].' - '.$customer['user_email'] ?></option>
                            <?php } ?>
                        </select>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-md-6">
                        <input type="text" id='quantity' required="required" name='quantity' placeholder="Số Lượng ..." class='form-control' value='<?php
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6">
                        <input type="text" id='total_votes' required="required" name='total_votes' placeholder="Phiếu Xuất Tổng ..." class='form-control' value='<?php
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6">
                        <input type="text" id='date_start' required="required" name='date_start' placeholder="Ngày Vận Chuyển ..." class='form-control datepicker' value='<?php
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6">
                        <input type="text" id='date_end' required="required" name='date_end' placeholder="Ngày Dự Tính Đến ..." class='form-control datepicker' value='<?php
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6">
                        <select id='verhicle_id' name='verhicle_id'class='select2 form-control' >
                ...
                <div class="form-group file-upload-box">
                    ...
                    <div class="col-md-5">
                        <input type="file" name="bill" class="file-input" title="Tải File (PDF/PNG/JPG)" />
                    </div>
                </div>
                <?php } else { ?>
                <div class="form-group file-upload-box">
                ...
                <div class="form-group" id="notes">
                    ...
                    <div class="col-md-offset-2 col-md-10" style="left: -15px; margin-bottom: 10px;">
                        <div class="col-md-1">
                            <button class="btn red remove-note" type='button'>Xóa</button>
                        </div>
                        <div class="col-md-3">
                            <input type="text" name='date[]' placeholder="Ngày..." class='form-control datepicker' value="<?php echo $note_data['date'] ?>" />
                        </div>
                        <div class="col-md-2">
                            <input type="text" name='time[]' placeholder="Giờ..." class='form-control timepicker' value="<?php echo $note_data['time'] ?>" />
                        </div>
                        <div class="col-md-3">
                            <input type="text" name='location[]' placeholder="Vị Trí..." class='form-control' value="<?php echo $note_data['location'] ?>" />
                        </div>
                        <div class="col-md-3">
                            <textarea name='text[]' placeholder="Ghi Chú..." class='form-control'><?php echo $note_data['text'] ?></textarea>
                        </div>
                    </div>
                    <?php } } else { ?>
                    <div class="col-md-10 col-md-offset-2" style="margin-left: -15px; margin-bottom: 10px;">
                        <div class="col-md-3">
                ...
                <div class="form-group">
                    <div class="col-md-10 col-md-offset-2">
                        <button class="btn yellow" id='btn-add' type='button'>Thêm Lịch Trình</button>
                    </div>
                </div>                
            </div>
            <div class="form-actions nobg fluid">
                <div class="col-md-offset-3 col-md-9">
                    <a href="<?php if(isset($info) && isset($info['is_copy']) && $info['is_copy']=='true') echo base_url().'quanly/bill/del/'.$info['id']; else echo base_url().'quanly/bill/listall'; ?>"  class="btn default">Hủy bỏ</a>
    ...
    $(document).ready(function() {
        ...
        $('#status').change(function(){
            if ($(this).val() == '2') {
                ...
                $('.file-upload-box input').attr('required', true);
            } else {
                $('.file-upload-box').hide();
                $('.file-upload-box input').attr('required', false);
            }
        })
