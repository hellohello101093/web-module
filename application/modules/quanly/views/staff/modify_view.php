    ...
    <div class="portlet box blue">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-reorder"></i><?php echo  (isset($info))?"Sửa ":"Thêm " ?>Nhân Viên
            </div>
            <div class="tools">
        ...
        <div class="portlet-body form">
            <!-- BEGIN FORM-->
            <form action='<?php echo base_url()?>quanly/staff/<?php echo $action ?>/<?php echo  (isset($info) && isset($info['user_id']))?$info['user_id']:"" ?>' class="form-horizontal" method="post">
                ...
                <div class="form-actions nobg fluid">
                    <div class="col-md-offset-3 col-md-9">
                        <a href="<?php echo base_url() ?>quanly/staff/listall"  class="btn default">Hủy bỏ</a>
