...
class Googlemaps {
	...
	function add_marker($params = array())
	{
		...
		$marker['not_search'] = '';								// trung custom
		...
		if ($marker['infowindow_content']!="") {
			...
			var mapDiv'.$marker_id.' = document.getElementById("mark_'.$marker_id.'");
            google.maps.event.addDomListener(mapDiv'.$marker_id.', "click", function(){
                google.maps.event.trigger(marker_'.$marker_id.', "click");
            });
			';
		}else{
			if ($marker['onclick']!="") { 
