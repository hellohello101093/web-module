...
<div class="header navbar navbar-fixed-top">
    ...
    <div class="header-inner">
        <!-- BEGIN LOGO -->
        <a class="navbar-brand" href="<?php echo base_url() ?>quanly" style="margin-left: 30px;font-weight: bold;color: #FFF ">
           Nguyên Phát
        </a>
        <!-- END LOGO -->
        ...
        <ul class="nav navbar-nav pull-right">
            ...
            <li class="dropdown user">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
					...
					<span class="username">
						 <?php $user = $this->session->userdata('user'); echo $user['user_name'] ?>
					</span>
...
<!-- add "navbar-no-scroll" class to disable the scrolling of the sidebar menu -->
    ...
    <?php
        if ($user['user_type'] === 'administrator'|| $user['user_type'] === 'manager') {
            $this->load->view('layout/manage/manager/menubar');   
        } else if ($user['user_type'] === 'staff') {
            $this->load->view('layout/manage/staff/menubar');
        } else if ($user['user_type'] === 'member') {
            $this->load->view('layout/manage/member/menubar');
        }
    ?>
